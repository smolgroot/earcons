...
describe("play* functions", () => {
  ...
  const allPlayers = [
    ...
    ["playPlugOut",      playPlugOut],
    ["playEightBit",     playEightBit],
    ["playPolice",       playPolice],
    ["playCoin",         playCoin],
    ["playBoing",        playBoing],
    ["playFailure",      playFailure],
    ["playJoyful",       playJoyful],
...
describe("earcon()", () => {
  ...
  it("plays built-in sounds by name", async () => {
    const names = [
      "success", "error", "warning", "notification", "click", "info",
      "toggle", "delete", "message", "plugIn", "plugOut", "upload", "download",
